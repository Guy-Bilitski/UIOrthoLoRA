...
_Last updated: 2026-07-13 11:54 IDT_
...
| [03_cs_faithful.md](03_cs_faithful.md) | Faithful CS repro (frc_) — fills as the spine lands | 82 |
| [04_rank_wd_matrix.md](04_rank_wd_matrix.md) | Rank/weight-decay matrix (mtx_/mtxm_), 3 seeds, per-config mean±SD | 110 |
| [05_qwen.md](05_qwen.md) | Qwen2.5-7B second-model replication: CS + math LR sweeps | 102 |
...
| [99_all_runs.md](99_all_runs.md) | Flat master table — every run, all metrics | 635 |
