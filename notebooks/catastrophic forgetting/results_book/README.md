...
_Last updated: 2026-07-12 17:54 IDT_
...
| [03_cs_faithful.md](03_cs_faithful.md) | Faithful CS repro (frc_) — fills as the spine lands | 42 |
...
| [99_all_runs.md](99_all_runs.md) | Flat master table — every run, all metrics | 582 |

_161 additional exploratory/legacy runs (uio*, clora_*, scl2_*, a5_*, grid_*, …) are classified `misc` and appear only in [99_all_runs.md](99_all_runs.md)._
