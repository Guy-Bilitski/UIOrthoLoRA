...
_Last updated: 2026-07-13 16:25 IDT_
...
| [05_qwen.md](05_qwen.md) | Qwen2.5-7B second-model replication: CS + math LR sweeps | 105 |
...
| [99_all_runs.md](99_all_runs.md) | Flat master table — every run, all metrics | 646 |
