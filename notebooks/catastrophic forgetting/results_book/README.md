...
_Last updated: 2026-07-12 23:24 IDT_
...
| [03_cs_faithful.md](03_cs_faithful.md) | Faithful CS repro (frc_) — fills as the spine lands | 56 |
...
| [99_all_runs.md](99_all_runs.md) | Flat master table — every run, all metrics | 599 |

_163 additional exploratory/legacy runs (uio*, clora_*, scl2_*, a5_*, grid_*, …) are classified `misc` and appear only in [99_all_runs.md](99_all_runs.md)._
