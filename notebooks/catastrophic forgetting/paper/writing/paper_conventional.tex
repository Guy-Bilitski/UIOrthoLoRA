...
singular value decomposition of $W_0$ and keep its first $256$ left singular
vectors as the columns of $U_{\mathrm{top}}$. Then
\begin{equation*}
...
output directions are kept.

\paragraph{The four shares.} Using the last $256$ left singular vectors
$U_{\mathrm{bot}}$ in place of $U_{\mathrm{top}}$ gives $e_{\mathrm{bot}}$.
Multiplying on the right instead, by the first or the last $256$ right
