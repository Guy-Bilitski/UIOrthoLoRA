...
def main() -> None:
    for lr, num_svalues, num_svectors, seed, init_sigma, init_scaler in itertools.product(SEARCH_LRS, NUM_SVALUES, NUM_SVECTORS, SEEDS, INIT_SIGMA, INIT_SCALER):
        ...
        run_tag      = f"2lr_{lr:g}_svalues_{num_svalues}_svectors_{num_svectors}_seed_{seed}_init_sigma_{LORA_CFG.initial_sigma}_init_scaler_{LORA_CFG.initial_scaler}"
