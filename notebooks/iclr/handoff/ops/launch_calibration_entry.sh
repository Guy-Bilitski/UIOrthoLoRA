#!/bin/bash
# Launch one registered calibration/refinement entry as a persistent controller.
# Usage: launch_calibration_entry.sh <protocol> <entry_id> <gpu> <session_name>
set -euo pipefail
CAMP=/media/eimtest/data/guyb/UIOrthoLoRA/notebooks/iclr-campaign-20260914
PF=notebooks/iclr/handoff/data/campaign_v1/preflight/20260916T003108Z_1c47e7ec/report.json
